...
namespace Odhiambo\LaravelEntrust;
...
class LaravelEntrustServiceProvider extends ServiceProvider
{
    ...
    protected $middlewares = [
        'role'          => \Odhiambo\LaravelEntrust\Middleware\LaravelEntrustRole::class,
        'permission'    => \Odhiambo\LaravelEntrust\Middleware\LaravelEntrustPermission::class,
        'ability'       => \Odhiambo\LaravelEntrust\Middleware\LaravelEntrustAbility::class,
    ];
    ...
    public function register()
    {
        ...
        $this->app->alias('LaravelEntrust', 'Odhiambo\LaravelEntrust\Facades\LaravelEntrustFacade');
    }
